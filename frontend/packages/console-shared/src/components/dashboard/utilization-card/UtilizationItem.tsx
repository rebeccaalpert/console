          ...
          {!error && (humanAvailable || humanMax) && (
            <div className="co-utilization-card__item-section">
              ...
              >
                {humanAvailable && (
                  <span>
                    {t('utilization-card~{{humanAvailable}} available', {
                      humanAvailable,
                    })}
                  </span>
                )}
              ...
              >
                {humanLimit && (
                  <span>{t('utilization-card~{{humanLimit}} total limit', { humanLimit })}</span>
                )}
                {!humanLimit && humanMax && (
                  <span>{t('utilization-card~of {{humanMax}}', { humanMax })}</span>
                )}
              </span>
            </div>
          )}
