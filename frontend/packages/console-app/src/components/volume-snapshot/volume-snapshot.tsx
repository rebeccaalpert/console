...
const Header = (disableItems = {}) => () => {
  return [
    {
      title: i18next.t('volume-snapshot~Name'),
      sortField: 'metadata.name',
      transforms: [sortable],
      props: { className: tableColumnClasses[0] },
    },
    {
      title: i18next.t('volume-snapshot~Namespace'),
    ...
    {
      title: i18next.t('volume-snapshot~Status'),
      sortFunc: 'snapshotStatus',
      transforms: [sortable],
      props: { className: tableColumnClasses[2] },
    },
    {
      title: i18next.t('volume-snapshot~Size'),
      sortFunc: 'volumeSnapshotSize',
      transforms: [sortable],
      props: { className: tableColumnClasses[3] },
    },
    {
      title: i18next.t('volume-snapshot~Source'),
      sortFunc: 'volumeSnapshotSource',
      transforms: [sortable],
      props: { className: tableColumnClasses[4] },
    },
    {
      title: i18next.t('volume-snapshot~Snapshot Content'),
      sortField: 'status.boundVolumeSnapshotContentName',
      transforms: [sortable],
      props: { className: tableColumnClasses[5] },
    },
    {
      title: i18next.t('volume-snapshot~Snapshot Class'),
      sortField: 'spec.volumeSnapshotClassName',
      transforms: [sortable],
      props: { className: tableColumnClasses[6] },
    },
    {
      title: i18next.t('volume-snapshot~Created At'),
