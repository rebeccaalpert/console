...
const VolumeSnapshotContentTable: React.FC = (props) => {
  ...
  const VolumeSnapshotContentTableHeader = () => {
    return [
      {
        title: t('volume-snapshot-content~Name'),
        sortField: 'metadata.name',
        transforms: [sortable],
        props: { className: tableColumnClasses[0] },
      },
      {
        title: t('volume-snapshot-content~Status'),
        sortFunc: 'snapshotStatus',
        transforms: [sortable],
        props: { className: tableColumnClasses[1] },
      },
      {
        title: t('volume-snapshot-content~Size'),
        sortFunc: 'volumeSnapshotSize',
        transforms: [sortable],
        props: { className: tableColumnClasses[2] },
      },
      {
        title: `${VolumeSnapshotModel.labelPlural}`,
        sortField: 'spec.volumeSnapshotRef.name',
        transforms: [sortable],
        props: { className: tableColumnClasses[3] },
      },
      {
        title: t('volume-snapshot-content~Snapshot Class'),
        sortField: 'spec.volumeSnapshotClassName',
        transforms: [sortable],
        props: { className: tableColumnClasses[4] },
      },
      {
        title: t('volume-snapshot-content~Created At'),
