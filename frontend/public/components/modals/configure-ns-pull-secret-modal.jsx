  ...
  render() {
    ...
    return <form onSubmit={this._submit} name="form" className="modal-content">
      ...
      <ModalBody>
        ...
        {existingData.invalidData && <Alert isInline className="co-alert" variant="danger" title="Overwriting default pull secret">A default pull secret exists, but can&rsquo;t be parsed. Saving this will overwrite it.</Alert>}
