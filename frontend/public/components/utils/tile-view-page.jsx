      ...
      <div className="co-catalog-page">
        ...
        <div className="co-catalog-page__content">
          ...
          {activeCategory.numItems > 0 && (
            <Gallery gutter="sm" className="catalog-tile-view-pf catalog-tile-view-pf-no-categories co-catalog-page__grid">
              {_.map(activeCategory.items, (item) => <GalleryItem key={`gallery-${item.uid}`}>{renderTile(item)}</GalleryItem>)}
            </Gallery>
          )}
